            ...
            <div className="container mx-auto px-4">
              <div className="backdrop-blur-md bg-[#121218]/70 rounded-xl p-8 border border-gray-800 max-w-4xl mx-auto">
                ...
                <div className="grid grid-cols-2 md:grid-cols-4 gap-8 mb-8">
                  ...
                  <div className="text-center">
                    <div className="w-16 h-16 mx-auto bg-[#ff0aff]/10 rounded-full flex items-center justify-center mb-3">
                      <svg className="w-8 h-8 text-[#ff0aff]" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
                  ...
                  <div className="text-center">
                    <div className="w-16 h-16 mx-auto bg-[#14ffc8]/10 rounded-full flex items-center justify-center mb-3">
                      <svg className="w-8 h-8 text-[#14ffc8]" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
