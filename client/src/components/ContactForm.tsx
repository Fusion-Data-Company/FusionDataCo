                ...
                <div className="relative z-10 h-full flex flex-col justify-between">
                  ...
                  <div className="glass-panel p-5 rounded-xl shadow-sm">
                    ...
                    <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                      <a href="tel:+19165340915" className="flex items-center gap-3 rounded-lg p-3 bg-muted/30 hover:bg-primary/10 transition-colors border border-border group">
                        ...
                        <div>
                          ...
                          <p className="text-xs text-muted-foreground">+1 (916) 534-0915</p>
                        </div>
                      </a>
